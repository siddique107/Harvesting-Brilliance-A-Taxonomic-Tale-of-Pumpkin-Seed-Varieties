...
- User-friendly web interface for inputting seed measurements
- Machine Learning model for accurate seed variety classification
- Instant prediction of pumpkin seed category
...
![Prediction](screenshots/Cercevelik form.png)
![Prediction](screenshots/Urgup Sivrisi form.png)
### Result Page

![Result](screenshots/Cercevelik result.png)
![Result](screenshots/Urgup Sivrisi Result.png)
## 👨‍💻 Developed By
